...
def main():
    ...
    for o,a in opts:
        ...
        def server_loop():
            ...
            server.bind((targer, port))

            server.listen(5)
            while True:
                client_socket, addr = server.accept()

                client_thread = threading.Thread(targer=client_sender(), args=(client_thread.start()))
        ...
        if not listen and len(targer) and port>0:
